...
<img src="imdb.jpg"   align="left" style="margin: 1% 3%" width="10%" height="70%" >
	 ...
	 <th >
	 <font  color="" FACE="Geneva, Arial" SIZE=6 font-weight=bold  STYLE=" font-family:'comic sans ms',cursive; " >
	...
	width: 230px;" name="search"  value="movie/ actor/ director/ producer..." onfocus="if(this.value!='') this.value='';"  >
	 ...
	 <td  align="center" style=" background-image: url('1.jpg');  height: 5px;"   >
	 <h2>Welcome 
	 <?php
	// session_start();
