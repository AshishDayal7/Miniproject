				...
				if($result = mysqli_query($link, $sql))
				{
					if(mysqli_num_rows($result) > 0)
					{
						...
						while($row = mysqli_fetch_array($result) )
						{
							...
							echo"<br>";
							echo"<table  border=5 align='center'  id='table1' width='80%'><col width='250'><col width='200'><col width='200'><col width='200'>";
							$image='m1/';
							$image.=$row['id'];
							$mid=$row['id'];
							$image.='.jpg';
							echo "<tr><td id='font1' rowspan='5' align='center' >";
							echo'<img src="'.$image .'"style="border-radius:20px;" border=7 height=320px width=270px/>';	
							echo "</td></tr>";
							echo "<tr><td id='font1'>"."Movie-Name:"."</td><td id='font1'>" . $row['name'] . "</td>";
							echo "<td id='font1' rowspan='4' align='center'>"; 
							?>
							<button type='submit' style='background-color:#e67300 ; border-radius:10px; ' name='<?php echo $submit ?>'  >
							<font  FACE='Geneva, Arial' SIZE=5	 id='mybutton' >Rate this Movie</font></button >
