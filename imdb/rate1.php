				...
				if($result = mysqli_query($link, $sql))
				{
					if(mysqli_num_rows($result) >0 )
					{
						$row= mysqli_fetch_array($result);
							echo"<br>";
							echo"<table  border=5 align='center' width='80%' id='table1'><col width='250'><col width='200'><col width='200'><col width='200'>";
							$image='m1/';
							$image.=$row['id'];
							$image.='.jpg';
							...
							if($result1 = mysqli_query($link, $sql1))//check and execute query..
							{
								if(mysqli_num_rows($result1)>0)
								{
									...
									<br>
									<button type='submit' style='background-color:#e67300 ; border-radius:10px; ' name='submit1'  >
									<?php 
									
									echo"<font  FACE='Geneva, Arial' SIZE=5 id='mybutton' >Rate this <br>Movie again</font></button ><br><br>";
									echo "</form>";
